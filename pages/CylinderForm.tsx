          ...
          <div className="form-content">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-section">
                ...
                <div className="hf-form-group">
                  <label className="hf-label">
                    1.1. Cylinder Application *
                  </label>
                  <textarea
                    className="hf-textarea"
                    name="purpose"
                    required
                    placeholder="Application description, machine or mechanism type"
                  ></textarea>
                </div>
                ...
                <div className="hf-form-group">
                  ...
                  <div className="hf-checkbox-group">
                    {['Single Acting', 'Double Acting', 'Telescopic'].map(
                      (type) => (
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="cylinder_other"
                        onChange={(e) =>
                          toggleVisibility('cylinder_other', e.target.checked)
                        }
                      />
                  ...
                  <div className="hf-checkbox-group">
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="medium_other"
                        onChange={(e) =>
                          toggleVisibility('medium_other', e.target.checked)
                        }
                      />
              ...
              <div className="form-section">
                  ...
                  <div className="hf-checkbox-group">
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="seal_other"
                        onChange={(e) =>
                          toggleVisibility('seal_other', e.target.checked)
                        }
                      />
                ...
                <div className="hf-form-group">
                  <label className="hf-label">
                    2.9. Cylinder Operating Position
                  </label>
                  <div className="hf-checkbox-group">
                    <div className="hf-checkbox-item">
                      <input
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="pos_other"
                        onChange={(e) =>
                          toggleVisibility('pos_other', e.target.checked)
                        }
                      />
                  ...
                  <div className="hf-checkbox-group">
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="body_special"
                        onChange={(e) =>
                          toggleVisibility('body_special', e.target.checked)
                        }
                      />
                  ...
                  <div className="hf-checkbox-group">
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="rod_other"
                        onChange={(e) =>
                          toggleVisibility('rod_other', e.target.checked)
                        }
                      />
                  ...
                  <div className="hf-checkbox-group">
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="port_other"
                        onChange={(e) =>
                          toggleVisibility('port_other', e.target.checked)
                        }
                      />
                  ...
                  <div className="hf-checkbox-group">
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="port_pos_custom"
                        onChange={(e) =>
                          toggleVisibility('port_pos_custom', e.target.checked)
                        }
                      />
                      <label htmlFor="port_pos_custom">
                        Per Drawing / Custom
                      </label>
                    </div>
              ...
              <div className="form-section">
                ...
                <div className="hf-form-group">
                  <label className="hf-label">
                    4.1. Duty Cycle (load, frequency, speed)
                  </label>
                  <textarea
                    className="hf-textarea"
                    name="work_cycle"
                    placeholder="Describe duty cycle"
                  ></textarea>
                </div>
                ...
                <div className="hf-inline-group">
                  ...
                  <div className="hf-form-group">
                    <label className="hf-label">
                      4.4. Cycle Frequency (per minute / hour)
                    </label>
                    <input
                      type="text"
                      className="hf-input"
                  ...
                  <div className="hf-checkbox-group">
                    {['Steel', 'Stainless Steel', 'Aluminum'].map((mat) => (
                      <div className="hf-checkbox-item" key={mat}>
                        <input
                          ...
                          value={mat.toLowerCase().split(' ')[0]}
                          id={`cyl_${mat.toLowerCase().split(' ')[0]}`}
                        />
                        <label
                          htmlFor={`cyl_${mat.toLowerCase().split(' ')[0]}`}
                        >
                          {mat}
                        </label>
                      </div>
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="cyl_other"
                        onChange={(e) =>
                          toggleVisibility('cyl_other', e.target.checked)
                        }
                      />
                  ...
                  <div className="hf-checkbox-group">
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="rod_mat_other"
                        onChange={(e) =>
                          toggleVisibility('rod_mat_other', e.target.checked)
                        }
                      />
                  ...
                  <div className="hf-checkbox-group">
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="coating_paint"
                        onChange={(e) =>
                          toggleVisibility('coating_paint', e.target.checked)
                        }
                      />
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="coating_other"
                        onChange={(e) =>
                          toggleVisibility('coating_other', e.target.checked)
                        }
                      />
              ...
              <div className="form-section">
                ...
                <div className="hf-form-group">
                  <label className="hf-label">
                    6.1. Position Sensors / Limit Switches
                  </label>
                  <div className="hf-checkbox-group">
                    <div className="hf-checkbox-item">
                      <input
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="sensors_yes"
                        onChange={(e) =>
                          toggleVisibility('sensors_yes', e.target.checked)
                        }
                      />
                  ...
                  <div className="hf-checkbox-group">
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="valves_other"
                        onChange={(e) =>
                          toggleVisibility('valves_other', e.target.checked)
                        }
                      />
                ...
                <div className="hf-form-group">
                  ...
                  <textarea
                    ...
                    placeholder="For example: CE certification, ATEX, marine environment, etc."
                  ></textarea>
                </div>

                <div className="hf-form-group">
                  <label className="hf-label">
                    6.4. 3D Model / Drawing Required for Approval
                  </label>
                  <div className="hf-checkbox-group">
                    <div className="hf-checkbox-item">
                      <input
              ...
              <div className="form-section">
                ...
                <div className="hf-form-group">
                  <label className="hf-label">
                    7.3. Delivery Terms (Incoterms)
                  </label>
                  <input
                    type="text"
                    className="hf-input"
                    name="incoterms"
                    placeholder="EXW, FCA, DAP, etc."
                  />
                </div>
                  ...
                  <div className="hf-checkbox-group">
                    ...
                    <div className="hf-checkbox-item">
                      <input
                        ...
                        id="pack_individual"
                      />
                      <label htmlFor="pack_individual">
                        Individual / Export Packaging
                      </label>
                    </div>
                    <div className="hf-checkbox-item">
                      <input
              ...
              <div className="form-section">
                ...
                <div className="hf-form-group">
                  <label className="hf-label">
                    Any drawings, schematics, photos or reference examples
                  </label>
                  <textarea
                    className="hf-textarea"
                    name="additional_info"
                    rows={5}
                    placeholder="Additional comments or links to files"
                  ></textarea>
                </div>
              </div>
