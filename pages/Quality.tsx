...
export const Quality: React.FC = () => {
  return (
    <>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
                <div className="w-full md:w-1/2">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed mb-6">
                      At Hydroforce Engineering, quality is not just a checkpoint—it's embedded in our culture. We utilize state-of-the-art measuring technology and rigorous inspection protocols to deliver components that exceed customer expectations.
                    </p>
                    <p className="text-lg text-gray-600 leading-relaxed mb-8">
                      Our quality management system is certified according to <strong>ISO 9001:2015</strong> standards, ensuring full traceability and consistency across all manufacturing processes, from Powder Metallurgy to CNC Machining and Die Casting.
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="bg-bg-light p-4 rounded-lg border-l-4 border-accent">
                            <strong className="block text-primary text-lg mb-1">Zero Defects</strong>
                        ...
                        <div className="bg-bg-light p-4 rounded-lg border-l-4 border-primary">
                            <strong className="block text-primary text-lg mb-1">Continuous Improvement</strong>
                ...
                <div className="w-full md:w-1/2">
                    <div className="rounded-2xl overflow-hidden shadow-2xl h-[400px]">
                        <img src="https://www.hydroforce.ee/wp-content/uploads/2025/07/zeiss-contura-laboratory.webp" alt="Zeiss Contura Laboratory" className="w-full h-full object-cover" />
                    </div>
                </div>
            </div>
        </div>
      ...
      <section className="py-20 bg-bg-light relative">
         ...
         <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
               <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Measuring & Testing Equipment</h2>
               <p className="text-xl text-gray-600">Advanced laboratory facilities for precise validation</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[300px]">
               <GalleryItem img="https://www.hydroforce.ee/wp-content/uploads/2025/07/Zeisse.webp" title="Zeiss CMM" />
               <GalleryItem img="https://www.hydroforce.ee/wp-content/uploads/2025/07/Image_20240725104137.webp" title="Digital Measurement" />
               <GalleryItem img="https://www.hydroforce.ee/wp-content/uploads/2025/07/Quality.webp" title="Visual Inspection" />
            </div>
         </div>
      </section>
      ...
      <section className="py-20 bg-white">
         <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-primary text-center mb-16">Quality Control Workflow</h2>
      ...
      <section className="py-20 bg-bg-light" id="standards">
         <div className="container mx-auto px-4">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Standards & Documentation</h2>
                <p className="text-xl text-gray-600">Full compliance with international standards</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
                <div className="bg-white p-8 rounded-xl shadow-card h-full">
                    <h3 className="text-2xl font-bold text-primary mb-6 border-b pb-2">Certifications</h3>
                    <ul className="space-y-4">
                        <li className="flex items-center gap-3 text-lg text-gray-700">
                            <span className="text-accent font-bold">✓</span> ISO 9001:2015
                        </li>
                        <li className="flex items-center gap-3 text-lg text-gray-700">
                            <span className="text-accent font-bold">✓</span> ISO 14001:2015
                        </li>
                        <li className="flex items-center gap-3 text-lg text-gray-700">
                            <span className="text-accent font-bold">✓</span> DNV / ABS / API (Product Specific)
                        </li>
                    </ul>
                </div>
                <div className="bg-white p-8 rounded-xl shadow-card h-full">
                    <h3 className="text-2xl font-bold text-primary mb-6 border-b pb-2">Documentation</h3>
                    <ul className="space-y-4">
                        <li className="flex items-center gap-3 text-lg text-gray-700">
                            <span className="text-accent font-bold">✓</span> PPAP Level 3 / APQP / FMEA
                        </li>
                        <li className="flex items-center gap-3 text-lg text-gray-700">
                            <span className="text-accent font-bold">✓</span> Material Certificates EN 10204 3.1
                        </li>
                        <li className="flex items-center gap-3 text-lg text-gray-700">
                            <span className="text-accent font-bold">✓</span> Dimensional Reports & Protocols
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="text-center">
                <div className="inline-block rounded-xl overflow-hidden shadow-lg bg-white p-2 max-w-3xl mx-auto">
                   <img src="https://www.hydroforce.ee/wp-content/uploads/2025/07/Image_20240725104235.webp" alt="Quality Certification" className="max-w-full h-auto max-h-[400px] object-contain rounded-lg" />
                </div>
            </div>
         </div>
      </section>
      ...
      <section className="py-16 bg-white text-center border-y border-gray-100">
          <div className="container mx-auto px-4">
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Need Reliable Manufacturing?</h2>
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">Contact our team to discuss your quality requirements and how we can meet your standards.</p>
...
const EquipmentCard = ({title, items}: {title: string, items: string[]}) => (
...
const StageCard = ({step, title, desc}: {step: string, title: string, desc: string}) => (
  <div className="relative bg-white p-8 pt-12 rounded-2xl shadow-card hover:-translate-y-2 transition-transform duration-300 border border-gray-100 h-full z-10">
     ...
     <h3 className="text-2xl font-bold text-primary mt-2 mb-4 text-center">{title}</h3>
