        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We manufacture standard metal parts in series with typical sizes
              and tolerances, leveraging a versatile machine park for efficient
            ...
            <div className="bg-white p-8 rounded-xl shadow-card h-full border-l-4 border-primary">
              ...
              <ul className="space-y-4">
                <li className="flex flex-col gap-1 text-gray-600 text-lg">
                  ...
                  Work envelope 1270 x 660 x 635 mm, high productivity and
                  reliability
                </li>
                <li className="flex flex-col gap-1 text-gray-600 text-lg">
                  <strong className="text-primary">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              'SPP1-removebg.webp',
              'Piston-backC-removebg.webp',
              'SPP3-removebg.webp',
              'SPP_4-removebg.webp',
            ].map((img, i) => (
              <div
                key={i}
                className="bg-white rounded-xl p-6 flex items-center justify-center shadow-md h-[250px] hover:-translate-y-1 transition-transform duration-300"
              >
                <img
      ...
      <section className="py-20 bg-bg-light relative" id="precision">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We produce series of components with tight tolerances, form
              accuracy, and surface finish. Dimensional repeatability within
              IT6-IT7 and geometric control aligned with ISO 2768-fH, ISO 286,
              ISO 1101.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {['HPC1-removebg.webp', 'HPC2-removebg.webp'].map((img, i) => (
              <div
                key={i}
                className="bg-white rounded-xl p-8 flex items-center justify-center shadow-lg h-[400px] hover:-translate-y-1 transition-transform duration-300"
              >
                <img
                  src={`https://www.hydroforce.ee/wp-content/uploads/2025/07/${img}`}
                  className="max-h-full max-w-full object-contain"
                  alt="High Precision Part"
                />
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-bg-light relative" id="large">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              A strategic focus area with capacity to machine large parts such
              as rods and shafts up to 2 meters diameter and 16 meters length,
              including custom hydraulic cylinder parts.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.26fr_0.74fr] gap-6 h-auto md:h-[400px]">
            <div className="bg-white rounded-xl overflow-hidden shadow-lg group h-[400px]">
              <img
                src="https://www.hydroforce.ee/wp-content/uploads/2025/07/LCC1.webp"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                alt="Large Component 1"
              />
            </div>
            <div className="bg-white rounded-xl overflow-hidden shadow-lg group h-[400px]">
              <img
                src="https://www.hydroforce.ee/wp-content/uploads/2025/07/LCC2.webp"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                alt="Large Component 2"
              />
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Delivering precision machining solutions across diverse industrial
              sectors
            </p>
          </div>
      ...
      <section className="py-16 bg-white text-center border-y border-gray-100">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Whether you need prototype support or full-scale production, we
            offer fast lead times, expert engineering, and reliable results.
          </p>
          <HashLink
            smooth
            to="#contacts"
      ...
      <section className="py-20 bg-bg-light relative" id="gears">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We produce custom gears of various sizes and complexities,
              including large gears up to several meters diameter, tailored to
              your specifications.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {['CG1.webp', 'CG2-removebg.webp', 'CG3-removebg.webp'].map(
              (img, i) => (
                <div
                  key={i}
                  className="bg-white rounded-xl p-6 flex items-center justify-center shadow-lg h-[350px] hover:-translate-y-1 transition-transform duration-300 overflow-hidden"
                >
                  <img
                    src={`https://www.hydroforce.ee/wp-content/uploads/2025/07/${img}`}
                    className="max-h-full max-w-full object-contain"
      ...
      <section className="py-20 bg-bg-light relative" id="materials">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We use a broad range of metals and alloys compliant with
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-8 rounded-xl shadow-card h-full border-l-4 border-primary">
              ...
              <ul className="space-y-4">
                {[
                  {
                    t: 'Carbon and alloy steels',
                    d: '(EN, DIN, AISI, ASTM) for structural strength',
                  },
                  {
                    t: 'Stainless steels',
                    d: '(EN 1.4301/304, 1.4404/316, etc.) for corrosion resistance',
                  },
                  {
                    t: 'Aluminum alloys',
                    d: '(6xxx, 7xxx series) for lightweight applications',
                  },
                  {
                    t: 'Titanium alloys',
                    d: '(EN standards) for high strength-to-weight ratio',
                  },
                  {
                    t: 'Copper and bronze alloys',
                    d: 'for thermal/electrical conductivity',
                  },
                ].map((item, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {['4.webp', '5.webp', 'Image_20240715110925.webp'].map((img, i) => (
              <div
                key={i}
                className="bg-white rounded-xl p-0 overflow-hidden shadow-lg h-[300px] hover:-translate-y-1 transition-transform duration-300 group"
              >
                <img
                  src={`https://www.hydroforce.ee/wp-content/uploads/2025/07/${img}`}
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
      ...
      <section className="py-20 bg-bg-light relative" id="quality">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Quality control is integral at every stage to guarantee
              reliability and compliance with high-demand sectors.
            </p>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm p-8 md:p-12 rounded-2xl shadow-xl border border-gray-100 mb-16">
            ...
            <ul className="space-y-4">
              {[
                {
                  l: 'Coverage',
                  v: 'Standard mass production parts, high-precision hydraulic and mechanical components, large shafts, housings, and flanges, custom gears including large diameter units',
                },
                {
                  l: 'Equipment',
                  v: 'Zeiss Contura CMM for geometry validation, gear measurement tools and profilometers, laser trackers and 3D scanners, manual inspection tools for parts up to 16 m long',
                },
                {
                  l: 'Inspection Regime',
                  v: 'Incoming and final inspection of geometry, materials, heat treatment, corrosion protection, marking, and packaging',
                },
                {
                  l: 'Standards Compliance',
                  v: 'EN ISO 2768, DIN ISO 286-1, ISO 1328, ISO 9001 and customer specifications',
                },
                {
                  l: 'Sectors Served',
                  v: 'Hydraulic and power transmission, energy and machinery manufacturing, heavy and custom equipment, mining, transport, and processing industries',
                },
              ].map((item, i) => (
                <li
                  key={i}
          ...
          <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-6 h-auto md:h-[320px]">
            <div className="bg-white rounded-xl overflow-hidden shadow-lg group h-[320px]">
              <img
                ...
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                alt="Zeiss Laboratory"
              />
            </div>
            <div className="bg-white rounded-xl overflow-hidden shadow-lg group h-[320px]">
              <img
                src="https://www.hydroforce.ee/wp-content/uploads/2025/07/Image_20240725104137.webp"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                alt="Measurement"
              />
            </div>
