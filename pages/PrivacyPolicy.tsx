      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <p className="mb-6">
              This Privacy Notice for Hydroforce Engineering OÜ (doing business as Hydroforce Engineering) ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
            </p>
            <ul className="list-disc list-inside mb-6 space-y-2">
              <li>Visit our website at https://hydroforce.ee, or any website of ours that links to this Privacy Notice</li>
              <li>Engage with us in other related ways, including any sales, marketing, or events</li>
            </ul>
            <p className="mb-6">
              <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at legal@hydroforce.ee.
            </p>

            <h2 className="text-2xl font-bold text-primary mb-4 mt-8 border-b pb-2">SUMMARY OF KEY POINTS</h2>
            ...
            <h2 className="text-2xl font-bold text-primary mb-4 mt-8 border-b pb-2">TABLE OF CONTENTS</h2>
            <ol className="list-decimal list-inside space-y-1 mb-8 font-medium text-primary">
              <li><HashLink smooth to="#section-1" className="hover:underline">WHAT INFORMATION DO WE COLLECT?</HashLink></li>
              <li><HashLink smooth to="#section-2" className="hover:underline">HOW DO WE PROCESS YOUR INFORMATION?</HashLink></li>
              <li><HashLink smooth to="#section-3" className="hover:underline">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</HashLink></li>
              <li><HashLink smooth to="#section-4" className="hover:underline">WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</HashLink></li>
              <li><HashLink smooth to="#section-5" className="hover:underline">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</HashLink></li>
              <li><HashLink smooth to="#section-6" className="hover:underline">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</HashLink></li>
              <li><HashLink smooth to="#section-7" className="hover:underline">HOW LONG DO WE KEEP YOUR INFORMATION?</HashLink></li>
              <li><HashLink smooth to="#section-8" className="hover:underline">HOW DO WE KEEP YOUR INFORMATION SAFE?</HashLink></li>
              <li><HashLink smooth to="#section-9" className="hover:underline">DO WE COLLECT INFORMATION FROM MINORS?</HashLink></li>
              <li><HashLink smooth to="#section-10" className="hover:underline">WHAT ARE YOUR PRIVACY RIGHTS?</HashLink></li>
              <li><HashLink smooth to="#section-11" className="hover:underline">CONTROLS FOR DO-NOT-TRACK FEATURES</HashLink></li>
              <li><HashLink smooth to="#section-12" className="hover:underline">DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</HashLink></li>
              <li><HashLink smooth to="#section-13" className="hover:underline">DO WE MAKE UPDATES TO THIS NOTICE?</HashLink></li>
              <li><HashLink smooth to="#section-14" className="hover:underline">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</HashLink></li>
              <li><HashLink smooth to="#section-15" className="hover:underline">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</HashLink></li>
            </ol>

            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-1">1. WHAT INFORMATION DO WE COLLECT?</h3>
            
            <h4 className="font-bold text-gray-800 mt-4 mb-2">Personal information you disclose to us</h4>
            ...
            <h4 className="font-bold text-gray-800 mt-4 mb-2">Information automatically collected</h4>
            ...
            <p className="mb-4">Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: https://www.hydroforce.ee/privacy-policy/.</p>
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-2">2. HOW DO WE PROCESS YOUR INFORMATION?</h3>
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-3">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h3>
            <p className="mb-4"><strong>In Short:</strong> We may share information in specific situations described in this section and/or with the following categories of third parties.</p>
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-4">4. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h3>
            <p className="mb-4"><strong>In Short:</strong> We are not responsible for the safety of any information that you share with third parties that we may link to or who advertise on our Services, but are not affiliated with, our Services.</p>
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-5">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h3>
            <p className="mb-4"><strong>In Short:</strong> We may use cookies and other tracking technologies to collect and store your information.</p>
            ...
            <p className="mb-4">Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: https://www.hydroforce.ee/privacy-policy/.</p>
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-6">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h3>
            <p className="mb-4"><strong>In Short:</strong> If you choose to register or log in to our Services using a social media account, we may have access to certain information about you.</p>
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-7">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h3>
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-8">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-9">9. DO WE COLLECT INFORMATION FROM MINORS?</h3>
            ...
            <p className="mb-4">We do not knowingly collect, solicit data from, or market to children under 18 years of age, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at legal@hydroforce.ee.</p>

            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-10">10. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
            <p className="mb-4"><strong>In Short:</strong> You may review, change, or terminate your account at any time, depending on your country, province, or state of residence.</p>
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-12">12. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h3>
            <p className="mb-4"><strong>In Short:</strong> You may have additional rights based on the country you reside in.</p>
            
            <h4 className="font-bold text-gray-800 mt-4 mb-2">Australia and New Zealand</h4>
            <p className="mb-4">We collect and process your personal information under the obligations and conditions set by Australia's Privacy Act 1988 and New Zealand's Privacy Act 2020 (Privacy Act).</p>
            <p className="mb-4">This Privacy Notice satisfies the notice requirements defined in both Privacy Acts, in particular: what personal information we collect from you, from which sources, for which purposes, and other recipients of your personal information.</p>
            <p className="mb-4">If you do not wish to provide the personal information necessary to fulfill their applicable purpose, it may affect our ability to provide our services, in particular:</p>
            <ul className="list-disc list-inside mb-4 ml-4">
            ...
            <h4 className="font-bold text-gray-800 mt-4 mb-2">Republic of South Africa</h4>
            <p className="mb-4">At any time, you have the right to request access to or correction of your personal information. You can make such a request by contacting us by using the contact details provided in the section "HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?"</p>
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-13">13. DO WE MAKE UPDATES TO THIS NOTICE?</h3>
            <p className="mb-4"><strong>In Short:</strong> Yes, we will update this notice as necessary to stay compliant with relevant laws.</p>
            <p className="mb-4">We may update this Privacy Notice from time to time. The updated version will be indicated by an updated "Revised" date at the top of this Privacy Notice. If we make material changes to this Privacy Notice, we may notify you either by prominently posting a notice of such changes or by directly sending you a notification. We encourage you to review this Privacy Notice frequently to be informed of how we are protecting your information.</p>

            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-14">14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h3>
            <p className="mb-4">If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO) by email at legal@hydroforce.ee, or contact us by post at:</p>
            <div className="mb-4 bg-gray-50 p-4 rounded border">
            ...
            <h3 className="text-xl font-bold text-primary mb-4 mt-10" id="section-15">15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
