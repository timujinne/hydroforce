    ...
    <>
      <Hero
        ...
        buttons={[
          ...
          { label: "View Capabilities", link: "#advantages", type: "secondary" }
        ]}
      />
      ...
      <section id="advantages" className="py-20 bg-bg-light relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">High-Pressure Die Casting (HPDC)</h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
             {[
               ...
               <div key={idx} className="bg-white p-6 rounded-xl shadow-md flex items-center justify-center h-48 hover:-translate-y-1 transition-transform duration-300">
                 <img src={`https://www.hydroforce.ee/wp-content/uploads/2025/07/${item.img}`} className="max-h-full max-w-full object-contain" alt={item.alt} />
               </div>
             ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-bg-light relative">
         ...
         <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Tooling & Mold Design</h2>
                <p className="text-xl text-gray-600">Advanced mold design and manufacturing capabilities for optimal die casting results</p>
            </div>
            
            <div className="bg-white/90 backdrop-blur-sm p-8 md:p-12 rounded-2xl shadow-xl border border-gray-100 mb-16">
                <h3 className="text-2xl font-bold text-primary mb-6 border-b border-gray-200 pb-4">Advanced Manufacturing Capabilities</h3>
                <ul className="space-y-4">
                    {[
                        { l: "Advanced CAD/CAM Design", v: "State-of-the-art software for optimal mold geometry and cooling channel design" },
                        { l: "Precision Machining", v: "CNC machining centers ensure accurate mold cavities and precise surface finishes" },
                        { l: "High-Quality Tool Steel", v: "Premium grade tool steels (H13, P20) for extended mold life and durability" },
                        { l: "Thermal Management", v: "Advanced cooling/heating systems for optimal cycle times and part quality" },
                        { l: "Ejection Systems", v: "Carefully designed ejector systems to prevent part damage and ensure smooth release" },
                        { l: "Quality Validation", v: "Comprehensive testing and validation before production to ensure optimal performance" }
                    ].map((item, i) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               {["mold1.webp", "mold2.webp", "mold3.webp"].map((img, i) => (
                 <div key={i} className="bg-white p-4 rounded-xl overflow-hidden shadow-lg h-[450px] group">
                    <img src={`https://www.hydroforce.ee/wp-content/uploads/2025/07/${img}`} className="w-full h-full object-cover rounded-lg group-hover:scale-105 transition-transform duration-500" alt="Mold" />
                 </div>
               ))}
            </div>
         </div>
      ...
      <section className="py-16 bg-white text-center border-y border-gray-100">
          <div className="container mx-auto px-4">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">Contact us for a consultation and quote.<br/>Tell us about your requirements — we'll provide the most efficient HPDC solution.</p>
      ...
      <section className="py-20 bg-bg-light relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Surface Finishing & Post-Processing</h2>
            </div>
            
            <div className="max-w-5xl mx-auto mb-16">
                <div className="text-center mb-8">
                    <h3 className="text-2xl font-bold text-primary mb-2">Comprehensive Finishing Services</h3>
                </div>
                <div className="bg-white p-10 rounded-2xl shadow-lg">
                    <ul className="space-y-4">
                        {[
                            { l: "Trimming & Deburring", v: "Precision removal of excess material and flash for clean part edges" },
                            { l: "CNC Machining", v: "Secondary machining operations for critical dimensions and features" },
                            { l: "Surface Treatments", v: "Anodizing, powder coating, and painting for enhanced appearance and protection" },
                            { l: "Heat Treatment", v: "T6 heat treatment for improved mechanical properties when required" },
                            { l: "Assembly Services", v: "Integration of inserts, fasteners, and sub-components" },
                            { l: "Quality Inspection", v: "Comprehensive dimensional and surface quality verification" }
                        ].map((item, i) => (
                            <li key={i} className="flex flex-col md:flex-row md:items-start gap-2 text-gray-700 text-lg border-b border-gray-100 last:border-0 pb-3 last:pb-0">
                                <strong className="text-primary min-w-[220px]">{item.l}:</strong>
                                <span>{item.v}</span>
                            </li>
                        ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                <div className="bg-white p-4 rounded-xl shadow-md h-[300px] overflow-hidden group">
                    <img src="https://www.hydroforce.ee/wp-content/uploads/2025/07/Surface1.webp" alt="Surface Treatment" className="w-full h-full object-cover rounded-lg group-hover:scale-105 transition-transform" />
                </div>
                <div className="bg-white p-4 rounded-xl shadow-md h-[300px] overflow-hidden group">
                    <img src="https://www.hydroforce.ee/wp-content/uploads/2025/07/Surface2.webp" alt="CNC Machining" className="w-full h-full object-cover rounded-lg group-hover:scale-105 transition-transform" />
                </div>
                <div className="bg-white p-4 rounded-xl shadow-md h-[300px] overflow-hidden group">
                    <img src="https://www.hydroforce.ee/wp-content/uploads/2025/07/Surface3.webp" alt="Quality Control" className="w-full h-full object-cover rounded-lg group-hover:scale-105 transition-transform" />
                </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white p-4 rounded-xl shadow-md h-[450px] overflow-hidden group">
                    <img src="https://www.hydroforce.ee/wp-content/uploads/2025/07/Prototype14.webp" alt="Finishing" className="w-full h-full object-cover rounded-lg group-hover:scale-105 transition-transform" />
                </div>
                <div className="bg-white p-4 rounded-xl shadow-md h-[450px] overflow-hidden group">
                    <img src="https://www.hydroforce.ee/wp-content/uploads/2025/07/Prototype15.webp" alt="Finishing Process" className="w-full h-full object-cover rounded-lg group-hover:scale-105 transition-transform" />
                </div>
            </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-bg-light relative">
         ...
         <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Quality Control</h2>
            </div>

            <div className="max-w-5xl mx-auto mb-16">
                <div className="text-center mb-8">
                    <h3 className="text-2xl font-bold text-primary mb-2">Quality Assurance Standards</h3>
                </div>
                <div className="bg-white p-10 rounded-2xl shadow-lg">
                    <ul className="space-y-4">
                        {[
                            { l: "Dimensional Inspection", v: "CMM (Coordinate Measuring Machine) for precise dimensional verification" },
                            { l: "Surface Quality Assessment", v: "Surface roughness measurement and visual inspection protocols" },
                            { l: "Material Testing", v: "Mechanical property testing and material composition analysis" },
                            { l: "Non-Destructive Testing", v: "X-ray inspection for internal defect detection when required" },
                            { l: "Statistical Process Control", v: "Real-time monitoring and control of production parameters" },
                            { l: "Certification Compliance", v: "ISO 9001 quality management system implementation" }
                        ].map((item, i) => (
                            <li key={i} className="flex flex-col md:flex-row md:items-start gap-2 text-gray-700 text-lg border-b border-gray-100 last:border-0 pb-3 last:pb-0">
                                <strong className="text-primary min-w-[250px]">{item.l}:</strong>
                                <span>{item.v}</span>
                            </li>
                        ))}
                    </ul>
            ...
            <div className="flex flex-col md:flex-row gap-8 h-auto md:h-[500px]">
               <div className="flex-[2] relative rounded-2xl overflow-hidden shadow-xl group min-h-[300px]">
                  <img src="https://www.hydroforce.ee/wp-content/uploads/2025/07/Zeisse.webp" alt="Zeiss Precision Measurement Systems" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
               ...
               <div className="flex-1 relative rounded-2xl overflow-hidden shadow-xl group min-h-[300px]">
                  <img src="https://www.hydroforce.ee/wp-content/uploads/2025/07/Quality.webp" alt="Quality Inspection Process" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
      ...
      <section id="industries" className="py-20 bg-bg-light">
        <div className="container mx-auto px-4">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Who We Serve?</h2>
                <p className="text-xl text-gray-600">Delivering high-pressure die casting solutions across diverse industrial sectors</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <AppCard 
                    title="Automotive" 
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-primary mb-8">Why Choose Us?</h2>
                <div className="max-w-3xl mx-auto">
                  <ul className="text-left space-y-6 text-xl text-gray-700">
                      {[
                          ...
                          <li key={i} className="border-b border-gray-100 pb-4 last:border-0 flex items-start gap-4">
...
const AdvantageCard = ({title, items}: {title: string, items: string[]}) => (
 ...
 const AppCard = ({ title, subtitle, items, bgImage, height = "h-[500px]" }: any) => (
    <div className={`relative ${height} rounded-2xl overflow-hidden group shadow-lg`}>
       ...
       <div className="absolute bottom-0 left-0 right-0 bg-primary/90 p-8 transition-colors duration-300 group-hover:bg-accent/95 flex flex-col justify-start">
          <h4 className="text-2xl font-bold text-white mb-2 border-b-2 border-white/30 pb-3 leading-snug shadow-sm">{title}</h4>
          {subtitle && <p className="text-white/90 text-lg font-medium mb-2">{subtitle}</p>}
          {items && (
