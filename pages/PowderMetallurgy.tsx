    ...
    <>
      <Hero
        ...
        buttons={[
            ...
            { label: "View Applications", link: "#applications", type: "secondary" }
        ]}
      />
      ...
      <section className="py-20 bg-bg-light relative overflow-hidden">
         ...
         <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Our Advantages</h2>
                <p className="text-xl text-gray-600">Cost-effective precision manufacturing with superior quality and design freedom</p>
            </div>
      ...
      <section id="applications" className="py-20 bg-white">
         <div className="container mx-auto px-4">
             <div className="text-center mb-12">
                 <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Applications & Industries</h2>
                 <p className="text-xl text-gray-600">Advanced powder metallurgy solutions for critical industry applications</p>
             </div>
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <AppCard 
      ...
      <section className="py-20 bg-bg-light relative" id="PM">
         ...
         <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Our Technology - Your Technical Advantage</h2>
                <p className="text-xl text-gray-600">Advanced powder metallurgy and metal injection molding capabilities</p>
            </div>

            <div className="bg-white/90 backdrop-blur-sm p-8 md:p-12 rounded-2xl shadow-xl border border-gray-100 mb-16">
                <h3 className="text-2xl font-bold text-primary mb-6 border-b border-gray-200 pb-4">Conventional Powder Metallurgy (Sintering)</h3>
                <ul className="space-y-4 mb-8">
                    {[
                        { l: "Materials", v: "Carbon and alloy steels, stainless steel, copper and copper alloys, titanium, and more" },
                        { l: "Sintering Temperature", v: "From 1100°C to 1400°C, precisely controlled to ±5°C for structural uniformity" },
                        { l: "Atmosphere", v: "Vacuum, inert gases (argon, nitrogen), or reducing atmospheres to prevent oxidation and surface defects" },
                        { l: "Compaction", v: "High-precision pressing up to 800 MPa ensures green density >95%" },
                        { l: "Tolerances", v: "Dimensional stability within ±0.05 mm after sintering" },
                        { l: "Post-processing", v: "CNC machining, heat treatment, and surface hardening if required" },
                        { l: "Quality Control", v: "Metallographic analysis, hardness testing (Rockwell, Vickers), ultrasonic and X-ray inspection" }
                    ].map((item, i) => (
                ...
                <div className="bg-[#e8f5e9] border-l-4 border-primary p-6 rounded-lg">
                    <strong className="text-primary block mb-1 text-lg">Your benefit:</strong>
                    <span className="text-gray-700 text-lg">High-strength parts with tight tolerances, optimized material usage and reduced finishing costs.</span>
                </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <GalleryItem img="https://www.hydroforce.ee/wp-content/uploads/2025/06/Merge-4.webp" title="Precision Gears" />
               <GalleryItem img="https://www.hydroforce.ee/wp-content/uploads/2025/06/DSCN9632-1.webp" title="Structural Parts" />
               <GalleryItem img="https://www.hydroforce.ee/wp-content/uploads/2025/06/Merge-3.webp" title="Complex Shapes" />
            </div>
         </div>
      </section>
      ...
      <section className="py-16 bg-white text-center border-y border-gray-100">
          <div className="container mx-auto px-4">
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Ready to Improve Your Product Performance?</h2>
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">Contact us for a consultation and quote.<br/>Tell us about your project — we'll provide the most efficient solution.</p>
      ...
      <section className="py-20 bg-bg-light relative" id="MIM">
         ...
         <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="bg-white/90 backdrop-blur-sm p-8 md:p-12 rounded-2xl shadow-xl border border-gray-100 mb-16">
                <h3 className="text-2xl font-bold text-primary mb-6 border-b border-gray-200 pb-4">Metal Injection Molding (MIM)</h3>
                <ul className="space-y-4 mb-8">
                    {[
                        { l: "Feedstock", v: "Ultra-fine metal powders (<20 μm) ensure >97% final density" },
                        { l: "Binders", v: "Specially formulated polymers enable clean debinding without deformation" },
                        { l: "Injection Molding", v: "Precise molding of complex shapes with thin walls down to 0.3 mm" },
                        { l: "Debinding", v: "Thermal or chemical removal with careful control to minimize internal stress" },
                        { l: "Sintering", v: "Programmable furnaces with inert or vacuum atmospheres prevent shrinkage and oxidation" },
                        { l: "Tolerances", v: "Standard ±0.02 mm, and down to ±0.01 mm with calibration" },
                        { l: "Surface Finish", v: "Ra as low as 0.4 μm without additional finishing" }
                    ].map((item, i) => (
                        <li key={i} className="flex flex-col md:flex-row md:items-start gap-2 text-gray-700 text-lg">
                            <strong className="text-primary min-w-[220px]">{item.l}:</strong>
                            <span>{item.v}</span>
                ...
                <div className="bg-[#e8f5e9] border-l-4 border-primary p-6 rounded-lg">
                    <strong className="text-primary block mb-1 text-lg">Your benefit:</strong>
                    <span className="text-gray-700 text-lg">Production of miniature, high-precision parts with minimal secondary operations.</span>
                </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <GalleryItem img="https://www.hydroforce.ee/wp-content/uploads/2025/07/MergeLightMIM-2.webp" title="Medical Components" />
               <GalleryItem img="https://www.hydroforce.ee/wp-content/uploads/2025/07/MergeBlackMIM-1.webp" title="Electronic Parts" />
               <GalleryItem img="https://www.hydroforce.ee/wp-content/uploads/2025/06/transparent-2.webp" title="Precision Parts" />
            </div>
         </div>
      </section>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Combined Advantages</h2>
                <p className="text-xl text-gray-600">Integrated PM and MIM solutions for optimal manufacturing results</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                <CombinedCard title="Integrated Approach" text="Combining PM and MIM allows us to offer the optimal solution depending on geometry, material, and production volume" />
                <CombinedCard title="Process Automation" text="Real-time process monitoring and control improves consistency and reduces rejection rates" />
                <CombinedCard title="Eco-Friendly Production" text="Low material waste and energy-efficient equipment reduce both cost and environmental footprint" />
                <CombinedCard title="Engineering Support" text="Our technical team works with you to adapt your design to best suit PM or MIM manufacturing" />
            </div>
      ...
      <section id="industries-served" className="py-20 bg-bg-light">
        <div className="container mx-auto px-4">
            <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">Delivering powder metallurgy solutions across diverse industrial sectors</p>
            </div>
...
const ShowcaseCard = ({img, title, subtitle}: {img: string, title: string, subtitle: string}) => (
