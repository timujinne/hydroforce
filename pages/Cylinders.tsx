...
export const Cylinders: React.FC = () => {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-xl">
              We specialize in challenges that standard solutions can't meet.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-6 lg:h-[500px]">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col h-[400px] lg:h-full group hover:-translate-y-2 transition-transform duration-300">
              <div className="flex-1 flex">
                <div
                  ...
                  style={{
                    backgroundImage: `url('https://www.hydroforce.ee/wp-content/uploads/2025/06/bigTwo-2.webp')`,
                  }}
                ></div>
                <div
                  className="w-1/2 bg-cover bg-center"
                  style={{
                    backgroundImage: `url('https://www.hydroforce.ee/wp-content/uploads/2025/06/4-3.webp')`,
                  }}
                ></div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 h-[400px] lg:h-full">
              <GridItem
                img="https://www.hydroforce.ee/wp-content/uploads/2025/09/5.webp"
                title="Ready for Shipment"
                subtitle="Large hydraulic cylinders prepared for delivery"
              />
              <GridItem
                img="https://www.hydroforce.ee/wp-content/uploads/2025/06/Image_20231215114449.webp"
                title="Custom Solutions"
                subtitle="Engineered to specification"
              />
              <GridItem
                img="https://www.hydroforce.ee/wp-content/uploads/2025/06/5-6.webp"
                title="Industrial Applications"
                subtitle="Heavy machinery systems"
              />
              <GridItem
                img="https://www.hydroforce.ee/wp-content/uploads/2025/06/Image_20220127125542.webp"
                title="Quality Testing"
                subtitle="100% performance validation"
              />
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <WhyCard
              ...
              text="Complete Production Cycle: design, machining, assembly, and testing capabilities"
            />
            <WhyCard
              title="Turnkey Manufacturing"
              text="From standard cylinders to complex telescopic systems and cylinders with progressive environments"
            />
            <WhyCard
              title="Engineering Excellence"
              text="Expert engineering support at every stage of the project with advanced CAD/CAM systems"
            />
            <WhyCard
              title="Quality & Standards"
              text="Consistent quality and full technical documentation compliant with ISO / DIN / DNV / ABS / API"
            />
          </div>
        </div>
      </section>
      ...
      <section id="industries" className="py-20 bg-bg-light">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-xl">
              Delivering hydraulic solutions across diverse industrial sectors
            </p>
          </div>
      ...
      <section
        id="products"
        className="py-28 bg-cover bg-center bg-fixed relative"
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(1, 87, 125, 0.9) 0%, rgba(1, 58, 82, 0.9) 100%), url('https://www.hydroforce.ee/wp-content/uploads/2025/10/Back-for-HC.webp')`,
        }}
      >
        <div className="container mx-auto px-4 relative z-10 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white/95 backdrop-blur-sm text-text-gray p-10 rounded-2xl shadow-2xl">
              <h3 className="text-2xl font-bold mb-6 border-b pb-4 text-primary">
                Parameters
              </h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>
                  <strong className="text-primary">Bore / Rod diameter:</strong>{' '}
                  up to 1000 mm
                </li>
                <li>
                ...
                <li>
                  <strong className="text-primary">
                    Number of telescopic stages:
                  </strong>{' '}
                  up to 9
                </li>
                <li>
                  <strong className="text-primary">Working pressure:</strong>{' '}
                  500 bar and more
                </li>
                <li>
                  <strong className="text-primary">
                ...
                <li>
                  <strong className="text-primary">Rod coatings:</strong> Chrome
                  plating, Titanium Nitride (TiN), Ceramic
                </li>
                <li>
                  <strong className="text-primary">Materials:</strong> Carbon
                  steel, stainless steel, titanium, bronze, exotic alloys
                </li>
                <li>
                  <strong className="text-primary">Sealing systems:</strong>{' '}
                  Parker, Hallite, Merkel, custom solutions
                </li>
                <li>
                  <strong className="text-primary">Sensors:</strong> Position,
                  pressure, temperature and other
                </li>
                <li>
                  <strong className="text-primary">Protocols:</strong> CANopen,
                  IO-link, analog signals
                </li>
              </ul>
            </div>
            <div className="bg-white/95 backdrop-blur-sm text-text-gray p-10 rounded-2xl shadow-2xl">
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={idx} className="flex gap-4 items-start group">
                    ...
                    <span className="text-lg text-gray-200 font-light leading-relaxed">
                      {item}
                    </span>
                  </li>
                ))}
              ...
              <div className="bg-white/5 rounded-2xl p-8 border border-white/10 hover:bg-white/10 transition-colors">
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={idx}
                      className="flex items-center gap-4 text-lg text-gray-200 font-light"
                    >
