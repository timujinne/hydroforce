  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans">
      ...
      <header className="sticky top-0 z-50 bg-[linear-gradient(135deg,#01577d_0%,#013a54_100%)] shadow-lg overflow-visible">
        ...
        <div className="container mx-auto px-0 h-20 lg:h-24 flex justify-between items-center relative z-20">
          ...
          <div className="h-full flex items-center bg-white pl-2 pr-2 lg:pl-4 lg:pr-[56px] relative lg:[clip-path:polygon(0_0,calc(100%-46px)_0,100%_100%,0_100%)] z-20 shadow-md">
            <Link
              ...
              className="block h-full w-auto py-0"
            >
              <img
                  ...
                  <button
                    className={`flex items-center gap-1 text-lg font-semibold tracking-wide py-8 transition-all hover:text-accent focus:outline-none ${
                      item.dropdown.some((d) => isActive(d.path))
                        ? 'text-white border-b-4 border-accent'
                        : 'text-gray-100'
                    }`}
                  >
                    {item.name}
        ...
        <div
          className={`lg:hidden bg-white border-t-4 border-accent absolute w-full transition-all duration-300 ease-in-out shadow-2xl overflow-y-auto ${isMobileMenuOpen ? 'max-h-[80vh] opacity-100' : 'max-h-0 opacity-0'}`}
        >
              ...
              <div key={item.name}>
                {item.dropdown ? (
                  <div>
                    ...
                    <div
                      className={`pl-4 space-y-1 overflow-hidden transition-all duration-300 ${openDropdown === item.name ? 'max-h-96 opacity-100 mt-1' : 'max-h-0 opacity-0'}`}
                    >
                      {item.dropdown.map((subItem) => (
                        <Link
                          key={subItem.name}
      ...
      <footer
        id="contacts"
        className="bg-[#002535] text-white pt-20 pb-10 relative overflow-hidden"
      >
        {/* Background Pattern */}
        ...
        <div className="container mx-auto px-4 relative z-10">
            ...
            <div>
              <div className="mb-10">
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-8 border-l-4 border-accent pl-4">
                  Whether you have a question about our hydraulic solutions,
                  need a quote for precision manufacturing, or want to discuss a
                  custom project, our engineering team is ready to help.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group">
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-1 text-white group-hover:text-accent transition-colors">
                      Headquarters
                    </h4>
                ...
                <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group">
                  ...
                  <div>
                    ...
                    <a
                      href="tel:+37256699464"
                      className="text-gray-300 hover:text-white transition-colors block font-mono text-lg"
                    >
                      +372 5669 94 64
                    </a>
                ...
                <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:office@hydroforce.ee"
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
            <div className="text-gray-400 text-sm flex flex-col md:flex-row gap-4 items-center">
              <span>
                &copy; {new Date().getFullYear()} Hydroforce Engineering. All
                rights reserved.
              </span>
              <Link
                to="/privacy-policy"
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/profile.php?id=61569990287623"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#1877F2] transition-all"
              >
                <Facebook size={18} />
              </a>
              <a
                href="https://www.linkedin.com/company/hydroforce-engineering/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#0A66C2] transition-all"
              >
                <Linkedin size={18} />
              </a>
            </div>
